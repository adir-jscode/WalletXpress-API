...
exports.updateApprovalStatusZodSchema = exports.updateUserZodSchema = exports.createUserZodSchema = void 0;
...
exports.updateApprovalStatusZodSchema = zod_1.default.object({
    approvalStatus: zod_1.default.enum(Object.values(user_interface_1.ApprovalStatus)),
});
